...
class TestMaintenanceWindowState(unittest.TestCase):
    """MaintenanceWindowState unit test stubs"""
    ...
    def testMaintenanceWindowState(self):
        """Test MaintenanceWindowState"""
        # inst = MaintenanceWindowState()
