...
class TestPagespeedTestHistoryResult(unittest.TestCase):
    """PagespeedTestHistoryResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagespeedTestHistoryResult:
        """Test PagespeedTestHistoryResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagespeedTestHistoryResult`
        """
        model = PagespeedTestHistoryResult()
        if include_optional:
    ...
    def testPagespeedTestHistoryResult(self):
        """Test PagespeedTestHistoryResult"""
