...
class TestSSLTests(unittest.TestCase):
    """SSLTests unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SSLTests:
        """Test SSLTests
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SSLTests`
        """
        model = SSLTests()
        if include_optional:
            return SSLTests(
                data = [
                    statuscake.models.ssl_test.SSLTest(
                        id = '', 
                        website_url = '', 
                        check_rate = 300, 
                        alert_at = [
