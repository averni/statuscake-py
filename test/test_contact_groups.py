...
class TestContactGroups(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ContactGroups:
        """Test ContactGroups
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactGroups`
        """
        model = ContactGroups()
        if include_optional:
            return ContactGroups(
                data = [
                    statuscake.models.contact_group.ContactGroup(
                        id = '', 
                        name = '', 
                        email_addresses = [
                            ''
