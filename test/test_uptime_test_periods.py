...
class TestUptimeTestPeriods(unittest.TestCase):
    """UptimeTestPeriods unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UptimeTestPeriods:
        """Test UptimeTestPeriods
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UptimeTestPeriods`
        """
        model = UptimeTestPeriods()
        if include_optional:
            return UptimeTestPeriods(
                data = [
                    statuscake.models.uptime_test_period.UptimeTestPeriod(
    ...
    def testUptimeTestPeriods(self):
        """Test UptimeTestPeriods"""
