...
class TestUptimeTest(unittest.TestCase):
    """UptimeTest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UptimeTest:
        """Test UptimeTest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UptimeTest`
        """
        model = UptimeTest()
        if include_optional:
            return UptimeTest(
