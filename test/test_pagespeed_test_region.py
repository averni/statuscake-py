...
class TestPagespeedTestRegion(unittest.TestCase):
    """PagespeedTestRegion unit test stubs"""
    ...
    def testPagespeedTestRegion(self):
        """Test PagespeedTestRegion"""
        # inst = PagespeedTestRegion()
