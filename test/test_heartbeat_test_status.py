...
class TestHeartbeatTestStatus(unittest.TestCase):
    """HeartbeatTestStatus unit test stubs"""
    ...
    def testHeartbeatTestStatus(self):
        """Test HeartbeatTestStatus"""
        # inst = HeartbeatTestStatus()
