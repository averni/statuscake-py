...
class TestMaintenanceWindowResponse(unittest.TestCase):
    """MaintenanceWindowResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaintenanceWindowResponse:
        """Test MaintenanceWindowResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaintenanceWindowResponse`
        """
        model = MaintenanceWindowResponse()
        if include_optional:
            return MaintenanceWindowResponse(
                data = statuscake.models.maintenance_window.MaintenanceWindow(
                    id = '', 
                    name = '', 
    ...
    def testMaintenanceWindowResponse(self):
        """Test MaintenanceWindowResponse"""
