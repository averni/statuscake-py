...
class TestMonitoringLocationStatus(unittest.TestCase):
    """MonitoringLocationStatus unit test stubs"""
    ...
    def testMonitoringLocationStatus(self):
        """Test MonitoringLocationStatus"""
        # inst = MonitoringLocationStatus()
