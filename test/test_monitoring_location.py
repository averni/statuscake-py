...
class TestMonitoringLocation(unittest.TestCase):
    """MonitoringLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitoringLocation:
        """Test MonitoringLocation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitoringLocation`
        """
    ...
    def testMonitoringLocation(self):
        """Test MonitoringLocation"""
