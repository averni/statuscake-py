...
class TestMaintenanceWindowRepeatInterval(unittest.TestCase):
    """MaintenanceWindowRepeatInterval unit test stubs"""
    ...
    def testMaintenanceWindowRepeatInterval(self):
        """Test MaintenanceWindowRepeatInterval"""
        # inst = MaintenanceWindowRepeatInterval()
