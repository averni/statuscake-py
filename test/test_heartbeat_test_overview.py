...
class TestHeartbeatTestOverview(unittest.TestCase):
    """HeartbeatTestOverview unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HeartbeatTestOverview:
        """Test HeartbeatTestOverview
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HeartbeatTestOverview`
        """
        model = HeartbeatTestOverview()
        if include_optional:
    ...
    def testHeartbeatTestOverview(self):
        """Test HeartbeatTestOverview"""
