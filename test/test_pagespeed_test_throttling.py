...
class TestPagespeedTestThrottling(unittest.TestCase):
    """PagespeedTestThrottling unit test stubs"""
    ...
    def testPagespeedTestThrottling(self):
        """Test PagespeedTestThrottling"""
        # inst = PagespeedTestThrottling()
