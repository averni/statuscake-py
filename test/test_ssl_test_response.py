...
class TestSSLTestResponse(unittest.TestCase):
    """SSLTestResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SSLTestResponse:
        """Test SSLTestResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SSLTestResponse`
        """
        model = SSLTestResponse()
        if include_optional:
            return SSLTestResponse(
                data = statuscake.models.ssl_test.SSLTest(
                    id = '', 
                    website_url = '', 
                    check_rate = 300, 
                    alert_at = [
