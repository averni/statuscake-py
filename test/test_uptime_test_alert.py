...
class TestUptimeTestAlert(unittest.TestCase):
    """UptimeTestAlert unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UptimeTestAlert:
        """Test UptimeTestAlert
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UptimeTestAlert`
        """
        model = UptimeTestAlert()
        if include_optional:
