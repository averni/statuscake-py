...
class TestUptimeTestAlerts(unittest.TestCase):
    """UptimeTestAlerts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UptimeTestAlerts:
        """Test UptimeTestAlerts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UptimeTestAlerts`
        """
        model = UptimeTestAlerts()
        if include_optional:
            return UptimeTestAlerts(
                data = [
                    statuscake.models.uptime_test_alert.UptimeTestAlert(
                        id = '', 
                        status = 'down', 
                        status_code = 0, 
