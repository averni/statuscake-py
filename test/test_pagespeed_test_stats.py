...
class TestPagespeedTestStats(unittest.TestCase):
    """PagespeedTestStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagespeedTestStats:
        """Test PagespeedTestStats
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagespeedTestStats`
        """
        model = PagespeedTestStats()
        if include_optional:
    ...
    def testPagespeedTestStats(self):
        """Test PagespeedTestStats"""
