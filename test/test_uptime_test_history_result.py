...
class TestUptimeTestHistoryResult(unittest.TestCase):
    """UptimeTestHistoryResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UptimeTestHistoryResult:
        """Test UptimeTestHistoryResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UptimeTestHistoryResult`
        """
        model = UptimeTestHistoryResult()
        if include_optional:
    ...
    def testUptimeTestHistoryResult(self):
        """Test UptimeTestHistoryResult"""
