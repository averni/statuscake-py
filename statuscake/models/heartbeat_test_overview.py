...
class HeartbeatTestOverview(BaseModel):
    """
    HeartbeatTestOverview
    """ # noqa: E501
    id: StrictStr = Field(description="Heartbeat check ID")
    name: StrictStr = Field(description="Name of the check")
    url: StrictStr = Field(description="URL of the check")
    period: Annotated[int, Field(le=172800, strict=True, ge=30)] = Field(description="Number of seconds since the last ping before the check is considered down")
    ...
    uptime: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Uptime percentage for a check")
    __properties: ClassVar[List[str]] = ["id", "name", "url", "period", "contact_groups", "paused", "status", "tags", "uptime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HeartbeatTestOverview from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HeartbeatTestOverview from a dict"""
        if obj is None:
            return None
