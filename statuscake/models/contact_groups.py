...
class ContactGroups(BaseModel):
    ...
    ContactGroups
    """ # noqa: E501
    data: List[ContactGroup] = Field(description="List of contact groups")
    metadata: Pagination
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ContactGroup.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
