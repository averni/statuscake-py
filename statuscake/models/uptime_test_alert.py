...
class UptimeTestAlert(BaseModel):
    """
    UptimeTestAlert
    """ # noqa: E501
    id: StrictStr = Field(description="Uptime check ID")
    status: UptimeTestStatus
    status_code: Annotated[int, Field(strict=True, ge=0)] = Field(description="Uptime check status code")
    triggered_at: Optional[datetime] = Field(default=None, description="When the alert was triggered (RFC3339 format)")
    __properties: ClassVar[List[str]] = ["id", "status", "status_code", "triggered_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UptimeTestAlert from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UptimeTestAlert from a dict"""
        if obj is None:
            return None
