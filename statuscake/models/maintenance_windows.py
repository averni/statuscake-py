...
class MaintenanceWindows(BaseModel):
    ...
    MaintenanceWindows
    """ # noqa: E501
    data: List[MaintenanceWindow] = Field(description="List of maintenance windows")
    metadata: Pagination
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MaintenanceWindows from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MaintenanceWindows from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [MaintenanceWindow.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
