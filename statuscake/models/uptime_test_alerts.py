...
class UptimeTestAlerts(BaseModel):
    """
    UptimeTestAlerts
    """ # noqa: E501
    data: List[UptimeTestAlert] = Field(description="List of uptime check alerts")
    links: Links
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UptimeTestAlerts from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UptimeTestAlerts from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [UptimeTestAlert.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
