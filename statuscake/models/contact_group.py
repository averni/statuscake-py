...
class ContactGroup(BaseModel):
    ...
    ContactGroup
    """ # noqa: E501
    id: StrictStr = Field(description="Contact group ID")
    name: StrictStr = Field(description="Name of the contact group")
    email_addresses: List[StrictStr] = Field(description="List of email addresses")
    integrations: List[StrictStr] = Field(description="List of configured integration IDs")
    mobile_numbers: List[StrictStr] = Field(description="List of international format mobile phone numbers")
    ping_url: Optional[StrictStr] = Field(default=None, description="URL or IP address of an endpoint to push uptime events. Currently this only supports HTTP GET endpoints")
    __properties: ClassVar[List[str]] = ["id", "name", "email_addresses", "integrations", "mobile_numbers", "ping_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mobile_numbers": obj.get("mobile_numbers"),
