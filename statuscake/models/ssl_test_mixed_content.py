...
class SSLTestMixedContent(BaseModel):
    """
    SSLTestMixedContent
    """ # noqa: E501
    src: StrictStr = Field(description="Full path to the content resource")
    type: StrictStr = Field(description="Type of the content")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SSLTestMixedContent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SSLTestMixedContent from a dict"""
        if obj is None:
            return None
