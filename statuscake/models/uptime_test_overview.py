...
class UptimeTestOverview(BaseModel):
    """
    UptimeTestOverview
    """ # noqa: E501
    id: StrictStr = Field(description="Uptime check ID")
    name: StrictStr = Field(description="Name of the check")
    website_url: StrictStr = Field(description="URL or IP address of the server under test")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "website_url", "test_type", "check_rate", "contact_groups", "paused", "status", "tags", "uptime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UptimeTestOverview from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UptimeTestOverview from a dict"""
        if obj is None:
            return None
