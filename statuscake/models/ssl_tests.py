...
class SSLTests(BaseModel):
    """
    SSLTests
    """ # noqa: E501
    data: List[SSLTest] = Field(description="List of SSL checks")
    metadata: Pagination
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SSLTests from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SSLTests from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [SSLTest.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
