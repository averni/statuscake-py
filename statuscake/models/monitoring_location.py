...
class MonitoringLocation(BaseModel):
    ...
    MonitoringLocation
    """ # noqa: E501
    description: StrictStr = Field(description="Server description")
    ipv4: Optional[StrictStr] = Field(default=None, description="Server IPv4 address")
    ipv6: Optional[StrictStr] = Field(default=None, description="Server IPv6 address")
    region: StrictStr = Field(description="Server region")
    region_code: StrictStr = Field(description="Server region code")
    status: MonitoringLocationStatus
    __properties: ClassVar[List[str]] = ["description", "ipv4", "ipv6", "region", "region_code", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MonitoringLocation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MonitoringLocation from a dict"""
        if obj is None:
            return None
