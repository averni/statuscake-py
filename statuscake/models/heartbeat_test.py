...
class HeartbeatTest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "url", "period", "contact_groups", "host", "last_tested_at", "paused", "status", "tags", "uptime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HeartbeatTest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HeartbeatTest from a dict"""
        if obj is None:
            return None
