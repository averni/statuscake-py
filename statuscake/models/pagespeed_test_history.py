...
class PagespeedTestHistory(BaseModel):
    """
    PagespeedTestHistory
    """ # noqa: E501
    data: List[PagespeedTestHistoryResult] = Field(description="List of pagespeed check history results")
    links: Links
    metadata: Optional[Dict[str, Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["data", "links", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PagespeedTestHistory from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PagespeedTestHistory from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [PagespeedTestHistoryResult.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
