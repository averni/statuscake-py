...
class PagespeedTests(BaseModel):
    """
    PagespeedTests
    """ # noqa: E501
    data: List[PagespeedTest] = Field(description="List of pagespeed checks")
    metadata: Pagination
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PagespeedTests from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PagespeedTests from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [PagespeedTest.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
