...
class APIResponseData(BaseModel):
    ...
    Response body
    """ # noqa: E501
    new_id: StrictStr = Field(description="ID of newly created resource.")
    __properties: ClassVar[List[str]] = ["new_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of APIResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of APIResponseData from a dict"""
        if obj is None:
            return None
